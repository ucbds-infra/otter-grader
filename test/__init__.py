    ...
    def assertDirsEqual(self, dir1, dir2, ignore_ext=[], ignore_dirs=[]):
        ...
        if os.path.isfile(dir1):
            ...
            dir1_contents, dir2_contents = (
                [f for f in os.listdir(dir1) if f not in ignore_dirs or not os.path.isdir(os.path.join(dir1, f))], 
                [f for f in os.listdir(dir2) if f not in ignore_dirs or not os.path.isdir(os.path.join(dir2, f))]
            )
