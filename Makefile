...
ifeq ($(OS), Darwin)
	...
	sed -i '' -e "s+ucbdsinfra/otter-grader+otter-test+" otter/generate/templates/general/run_autograder
else
	sed -i "s+ucbdsinfra/otter-grader+otter-test+" otter/generate/templates/python/setup.sh
	sed -i "s+ucbdsinfra/otter-grader+otter-test+" otter/generate/templates/general/run_autograder
endif
...
ifeq ($(OS), Darwin)
	...
	sed -i '' -e "s+otter-test+ucbdsinfra/otter-grader+" otter/generate/templates/general/run_autograder
else
	sed -i "s+otter-test+ucbdsinfra/otter-grader+" otter/generate/templates/python/setup.sh
	sed -i "s+otter-test+ucbdsinfra/otter-grader+" otter/generate/templates/general/run_autograder
endif
