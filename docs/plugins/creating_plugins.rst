...
``Notebook.run_plugin`` will be passed to the plugin mehod. This method should not return anything 
...
``otter.Notebook.add_plugin_files`` witht he plugin name. Any additional args and kwargs passed to 
``Notebook.add_plugin_files`` will be passed to the plugin mehod. This method should return a list 
