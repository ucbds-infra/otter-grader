...
def output_to_rkt(query, question, output_file, sql_filename = "query.sql"):
    try:
        ...
        results = json.loads(run_equiv_check(output_file, "/Cosette/", 3))
        print("RESULTS FROM COSETTE", results)
